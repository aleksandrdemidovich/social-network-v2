...
function RightHeaderMenu() {
    ...
    return (
        <div className={s.rightHeaderMenu}>
            <button onBlur={() => {setOpen(false)}} onClick={() => {checkToggle(open)}} className={s.rightMenuButton}><img src="https://www.seoclerk.com/pics/319222-1IvI0s1421931178.png" alt='user-avatar'/>
